...
export const translations = {
  en: {
    ...
    'auth.signup.error': 'Please try again',
    'auth.resetPassword.error': 'Failed to reset password',
    'auth.forgotPassword.error': 'Failed to send reset email',
    ...
    'admin.clients.rateLimit.label': 'Rate Limit (msgs/min)',
    'admin.clients.rateLimit.description': 'Maximum messages per minute',
    'admin.clients.businessName.label': 'Business Name',
    'admin.clients.businessName.description': 'Business name for 2-way SMS routing and contact tagging',
    ...
    'contacts.selectClient': "Select which client's contacts to manage",
    ...
    'contacts.contactGroups': 'Contact Groups',
    ...
    'contacts.error.exportFailed': 'Failed to export contacts',
    ...
    'sendSms.single.description': 'Send an SMS to a single recipient',
    'sendSms.single.selectContact': 'Select from Contacts',
    'sendSms.single.send': 'Send SMS',
    'sendSms.single.sending': 'Sending...',
    'sendSms.bulk.title': 'Send Bulk SMS',
    'sendSms.bulk.description': 'Send the same message to multiple recipients',
    ...
    'sendSms.bulkMulti.title': 'Send Bulk Multi SMS',
    'sendSms.bulkMulti.description': 'Send different messages to different recipients',
    ...
    'sendSms.bulkMulti.addAnother': '+ Add Another Message',
    'sendSms.bulkMulti.send': 'Send',
    'sendSms.bulkMulti.messages': 'Messages',
    'sendSms.bulkMulti.sending': 'Sending...',
    'sendSms.bulkMulti.recipientPlaceholder': 'Recipient phone number',
    'sendSms.bulkMulti.messagePlaceholder': 'Message for this recipient',
    ...
    'sendSms.error.fillFields': 'Please fill in all fields',
    'sendSms.error.provideRecipients': 'Please provide recipients and message',
    'sendSms.error.provideMessage': 'Please provide at least one valid message',
    ...
    'inbox.viewConversation': 'View Conversation',
    'inbox.success.replySent': 'Reply sent successfully',
    'inbox.error.replyFailed': 'Failed to send reply',
    'inbox.error.enterReply': 'Please enter a reply message',
    'inbox.error.fetchFailed': 'Failed to fetch messages',
    'inbox.adminMode': 'Admin Mode',
    'inbox.adminModeDesc': 'Viewing inbox for',
    'inbox.selectClient': 'Select a client to view their inbox',
    
    // Message History / DLR
    'messageHistory.title': 'SMS History',
    'messageHistory.subtitle': 'View your recent SMS messages and their delivery status',
    ...
    'messageHistory.status.queued': 'Queued',
    'messageHistory.status.sent': 'Sent',
    'messageHistory.status.delivered': 'Delivered',
    'messageHistory.status.failed': 'Failed',
    'messageHistory.empty': 'No messages found',
    'messageHistory.emptyDesc': 'Your sent messages will appear here',
    'messageHistory.showing': 'Showing',
    'messageHistory.messages': 'messages',
    'messageHistory.page': 'Page',
    'messageHistory.of': 'of',
    'messageHistory.loading': 'Loading messages...',
    'messageHistory.error.fetchFailed': 'Failed to fetch message history',
    'messageHistory.checkStatus': 'Check Status',
    'messageHistory.refreshStatus': 'Refresh Status',
    'messageHistory.adminMode': 'Admin Mode',
    'messageHistory.adminModeDesc': 'Viewing message history for',
    'messageHistory.selectClient': 'Select a client to view their message history',
  ...
  zh: {
    ...
    'auth.login.error': '无效凭据',
    'auth.signup.error': '请重试',
    'auth.resetPassword.error': '重置密码失败',
    'auth.forgotPassword.error': '发送重置邮件失败',
    ...
    'admin.clients.table.businessName': '企业名称',
    'admin.clients.status.active': '活跃',
    'admin.clients.status.inactive': '不活跃',
    'admin.clients.actions.view': '查看',
    'admin.clients.rateLimit.label': '速率限制（条/分钟）',
    'admin.clients.rateLimit.description': '每分钟最大消息数',
    'admin.clients.businessName.label': '企业名称',
    'admin.clients.businessName.description': '用于双向短信路由和联系人标记的企业名称',
    'admin.clients.businessName.placeholder': '输入企业名称',
    ...
    'contacts.success.exported': '联系人导出成功',
    'contacts.error.exportFailed': '导出联系人失败',
    ...
    'sendSms.single.description': '向单个收件人发送短信',
    'sendSms.single.selectContact': '从联系人中选择',
    'sendSms.single.send': '发送短信',
    'sendSms.single.sending': '发送中...',
    'sendSms.bulk.title': '发送批量短信',
    'sendSms.bulk.description': '向多个收件人发送相同消息',
    ...
    'sendSms.bulk.sending': '发送中...',
    'sendSms.bulk.manualEntry': '手动输入',
    'sendSms.bulk.fromGroup': '从分组选择',
    'sendSms.bulkMulti.title': '发送批量多条短信',
    'sendSms.bulkMulti.description': '向不同收件人发送不同消息',
    ...
    'sendSms.bulkMulti.addAnother': '+ 添加另一条消息',
    'sendSms.bulkMulti.send': '发送',
    'sendSms.bulkMulti.messages': '条消息',
    'sendSms.bulkMulti.sending': '发送中...',
    'sendSms.bulkMulti.recipientPlaceholder': '收件人电话号码',
    'sendSms.bulkMulti.messagePlaceholder': '此收件人的消息内容',
    ...
    'sendSms.error.fillFields': '请填写所有字段',
    'sendSms.error.provideRecipients': '请提供收件人和消息内容',
    'sendSms.error.provideMessage': '请至少提供一条有效消息',
    ...
    'inbox.noMessagesDesc': '收到的短信消息将显示在此处',
    'inbox.originalMessage': '原始消息',
    'inbox.conversation': '对话',
    'inbox.typeReply': '输入您的回复...',
    'inbox.pressEnterToSend': '按回车键发送，Shift+回车换行',
    'inbox.unreadIndicator': '未读',
    'inbox.viewConversation': '查看对话',
    'inbox.success.replySent': '回复发送成功',
    'inbox.error.replyFailed': '回复发送失败',
    'inbox.error.enterReply': '请输入回复消息',
    'inbox.error.fetchFailed': '获取消息失败',
    'inbox.adminMode': '管理员模式',
    'inbox.adminModeDesc': '正在查看收件箱',
    'inbox.selectClient': '选择客户以查看其收件箱',
    
    // Message History / DLR
    'messageHistory.title': '短信历史记录',
    'messageHistory.subtitle': '查看您最近的短信消息及其发送状态',
    'messageHistory.search': '搜索消息...',
    'messageHistory.table.recipient': '接收者',
    ...
    'messageHistory.status.queued': '排队中',
    'messageHistory.status.sent': '已发送',
    'messageHistory.status.delivered': '已送达',
    'messageHistory.status.failed': '失败',
    'messageHistory.empty': '未找到消息',
    'messageHistory.emptyDesc': '您发送的消息将显示在此处',
    'messageHistory.showing': '显示',
    'messageHistory.messages': '条消息',
    'messageHistory.page': '页',
    'messageHistory.of': '/',
    'messageHistory.loading': '加载消息中...',
    'messageHistory.error.fetchFailed': '获取消息历史记录失败',
    'messageHistory.checkStatus': '检查状态',
    'messageHistory.refreshStatus': '刷新状态',
    'messageHistory.adminMode': '管理员模式',
    'messageHistory.adminModeDesc': '正在查看消息历史记录',
    'messageHistory.selectClient': '选择客户以查看其消息历史记录',
